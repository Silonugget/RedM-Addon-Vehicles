...
Locales["en_lang"] = {
    ------------------------------------------------
    -- MAIN MENU
    MenuTitle                 = "RobinHOOD FreeRoam",
    MenuSubTitle              = "Misc Menu",
    ...
    ------------------------------------------------------------------------------
    -- USERSMENU
    Scoreboard                = "Close Menu",
    scoreboard_desc           = "Closes this menu",
    Report                    = "Revive",
    reportoptions_desc        = "Revive in place",
    requeststaff              = "Request staff",
    Requeststaff_desc         = "Request staff if you need help they will reach out to you",
    requeststaff_disc         = "Player requested staff",
    requeststaff_bug          = "Player found bug",
    requeststaff_rulesbroke   = "Player reported rules broken",
    requeststaff_cheating     = "Player reported someone cheating",
    createticket              = "create ticket",
    tickectdiscord_desc       = " create a tick to discord NO",
    showMyInfo                = "Vehicles",
    showmyinfo_desc           = "Spawn Rides",
